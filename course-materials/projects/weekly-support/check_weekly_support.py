...
if "PROGRAM INCOMPLETE" in TARGET.read_text(encoding="utf-8"):
    print("Weekly support report automatic check")
    print("Target:", TARGET)
    print("[NG] starter program is not complete")
    print("     Complete the TODOs first and remove the final PROGRAM INCOMPLETE line.")
    raise SystemExit(1)
...
if failures:
    ...
    print("Change only weekly_support.py and run this checker again.")
    raise SystemExit(1)
print("\nALL TESTS PASSED")
