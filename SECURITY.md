...
DockerSpawner requires control of the Docker daemon. The current local phase
...
Before production release, use Moodle LTI 1.3 through HTTPS, remove the local
JWKS workaround, isolate Docker control on a dedicated host or stronger daemon
boundary, define backup and restore procedures, and complete a threat review.
